...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.fd, request.fV, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.fV));
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dy: fragment, dC: host, d_: path, d0: port_, d5: protocol, cU: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {T: frag, fx: params, O: unvisited, eA: value, X: visited};
	});
var $elm$url$Url$Parser$getFirstMatch = function (states) {
	...
	while (true) {
		if (!states.b) {
			...
			var _v1 = state.O;
			if (!_v1.b) {
				return $elm$core$Maybe$Just(state.eA);
			} else {
				if ((_v1.a === '') && (!_v1.b.b)) {
					return $elm$core$Maybe$Just(state.eA);
				} else {
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.d_),
...
var $author$project$Pages$Login$Model = F4(
	function (user, key, email, password) {
		return {aw: email, e9: key, cP: password, P: user};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{eI: false, eK: r.eK, eW: r.eW, e1: r.e1, fd: r.fd, fL: r.fL, fT: r.fT, fV: r.fV}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{eK: r.eK, eW: r.eW, e1: _List_Nil, fd: 'POST', fL: $elm$core$Maybe$Nothing, fT: $elm$core$Maybe$Nothing, fV: r.fV});
};
	...
	return $elm$http$Http$post(
		{
			...
			eW: A2(
				...
				options.fr,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			fV: $author$project$Api$User$loginUrl
		});
};
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$User$authentication(
						{
							fr: $author$project$Pages$Login$GotUser,
							...
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										A2($author$project$Utils$Route$navigate, model.e9, $author$project$Spa$Generated$Route$Projects)
									]));
						} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder(options.fa),
						$elm$html$Html$Attributes$type_(options.ez),
						$elm$html$Html$Attributes$value(options.eA),
						$elm$html$Html$Events$onInput(options.dX)
					]),
				_List_Nil)
			]));
};
							...
							[
								...
								_List_fromArray(
									[
											...
											[
												...
												_List_fromArray(
													[
														...
														$author$project$Spa$Generated$Route$toString(options.dg.fD))
													]),
												_List_fromArray(
													[
														$elm$html$Html$text(options.dg.fa)
													]))
											])),
										function () {
										var _v0 = options.P;
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onSubmit(options.fp)
											]),
	...
	return {
		eK: _List_fromArray(
			[
				...
				{
					dg: {fa: 'Need an account?', fD: $author$project$Spa$Generated$Route$Register},
					e$: _List_fromArray(
						[
							{
							fa: 'Email',
							dX: $author$project$Pages$Login$Updated(0),
							ez: 'text',
							eA: model.aw
						},
							{
							fa: 'Password',
							dX: $author$project$Pages$Login$Updated(1),
							ez: 'password',
							eA: model.cP
						}
						]),
					fa: 'Sign in',
					fp: $author$project$Pages$Login$AttemptedSignIn,
					P: model.P
				})
			]),
		fM: 'Sign in'
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{e7: $author$project$Pages$Login$init, fc: $author$project$Pages$Login$load, fE: $author$project$Pages$Login$save, fI: $author$project$Pages$Login$subscriptions, fU: $author$project$Pages$Login$update, fW: $author$project$Pages$Login$view});
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{fW: $author$project$Pages$NotFound$view});
		...
		return $elm$http$Http$request(
			{
				...
				fd: method,
				fL: $elm$core$Maybe$Just(1000 * 60),
...
var $author$project$Api$Profile$get = function (options) {
	return A2(
		...
		options.db,
		{
			...
			fV: 'https://conduit.productionready.io/api/profiles/' + options.ch
		});
};
...
var $author$project$Pages$Profile$Username_String$init = F2(
	function (shared, _v0) {
		...
		var token = A2(
			...
			shared.P);
		return _Utils_Tuple2(
			{dP: $author$project$Api$Data$Loading, D: 1, cT: $author$project$Api$Data$Loading, cY: 0, P: shared.P, ch: params.ch},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Api$Profile$get(
						{fr: $author$project$Pages$Profile$Username_String$GotProfile, db: token, ch: params.ch})
					])));
	});
...
var $author$project$Pages$Profile$Username_String$page = $author$project$Spa$Page$application(
	{e7: $author$project$Pages$Profile$Username_String$init, fc: $author$project$Pages$Profile$Username_String$load, fE: $author$project$Pages$Profile$Username_String$save, fI: $author$project$Pages$Profile$Username_String$subscriptions, fU: $author$project$Pages$Profile$Username_String$update, fW: $author$project$Pages$Profile$Username_String$view});
var $author$project$Pages$Projects$GotProjects = $elm$core$Basics$identity;
var $author$project$Api$Project$Project = F2(
	function (name, description) {
		return {eS: description, ff: name};
	});
...
var $author$project$Pages$Projects$init = F2(
	function (shared, _v0) {
		var model = {dP: $author$project$Api$Data$Loading, P: shared.P};
		return _Utils_Tuple2(
			model,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
...
var $author$project$Pages$Projects$page = $author$project$Spa$Page$application(
	{e7: $author$project$Pages$Projects$init, fc: $author$project$Pages$Projects$load, fE: $author$project$Pages$Projects$save, fI: $author$project$Pages$Projects$subscriptions, fU: $author$project$Pages$Projects$update, fW: $author$project$Pages$Projects$view});
var $author$project$Pages$Register$Model = F5(
	function (user, key, username, email, password) {
		return {aw: email, e9: key, cP: password, P: user, ch: username};
	});
...
var $author$project$Api$User$registration = function (options) {
	...
	return $elm$http$Http$post(
		{
			eK: $elm$http$Http$jsonBody(body),
			eW: A2(
				$author$project$Api$Data$expectJson,
				options.fr,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			fV: 'https://conduit.productionready.io/api/users'
		});
};
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$User$registration(
						{
							fr: $author$project$Pages$Register$GotUser,
						...
						if (!_v4.$) {
							...
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Ports$saveUser(user_),
										A2($author$project$Utils$Route$navigate, model.e9, $author$project$Spa$Generated$Route$Top)
									]));
						} else {
							return $elm$core$Platform$Cmd$none;
						}
	...
	return {
		eK: _List_fromArray(
			[
				$author$project$Components$UserForm$view(
				{
					dg: {fa: 'Have an account?', fD: $author$project$Spa$Generated$Route$Login},
					e$: _List_fromArray(
						[
							{
							fa: 'Your Name',
							dX: $author$project$Pages$Register$Updated(0),
							ez: 'text',
							eA: model.ch
						},
							{
							fa: 'Email',
							dX: $author$project$Pages$Register$Updated(1),
							ez: 'email',
							eA: model.aw
						},
							{
							fa: 'Password',
							dX: $author$project$Pages$Register$Updated(2),
							ez: 'password',
							eA: model.cP
						}
						]),
					fa: 'Sign up',
					fp: $author$project$Pages$Register$AttemptedSignUp,
					P: model.P
				})
			]),
		fM: 'Sign up'
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{e7: $author$project$Pages$Register$init, fc: $author$project$Pages$Register$load, fE: $author$project$Pages$Register$save, fI: $author$project$Pages$Register$subscriptions, fU: $author$project$Pages$Register$update, fW: $author$project$Pages$Register$view});
...
var $author$project$Api$Token$put = F2(
	function (token, options) {
		return A4($author$project$Api$Token$request, 'PUT', options.eK, token, options);
	});
	...
	return A2(
		...
		$elm$core$Maybe$Just(options.db),
		{
			...
			eW: A2(
				...
				options.fr,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			fV: 'https://conduit.productionready.io/api/user'
		});
};
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					$author$project$Api$User$update(
						{fr: $author$project$Pages$Settings$GotUser, db: user.db, P: model}));
			default:
				switch (msg.a.$) {
					case 3:
						var user = msg.a.a;
...
var $author$project$Pages$Settings$page = $author$project$Spa$Page$application(
	{
		e7: $author$project$Pages$Settings$init,
		fc: $author$project$Pages$Settings$load,
		fE: $author$project$Pages$Settings$save,
		fI: $author$project$Pages$Settings$subscriptions,
		fU: $author$project$Pages$Settings$update,
		fW: $author$project$Utils$Auth$protected($author$project$Pages$Settings$view)
	});
...
var $author$project$Pages$Top$init = F2(
	function (shared, _v0) {
		...
		var model = {dd: activeTab, dP: $author$project$Api$Data$Loading, eq: $author$project$Api$Data$Loading, P: shared.P};
		return _Utils_Tuple2(
			model,
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{e7: $author$project$Pages$Top$init, fc: $author$project$Pages$Top$load, fE: $author$project$Pages$Top$save, fI: $author$project$Pages$Top$subscriptions, fU: $author$project$Pages$Top$update, fW: $author$project$Pages$Top$view});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.e7,
						shared,
						A3($author$project$Spa$Url$create, params, shared.e9, shared.fV)));
			});
		...
		return {E: bundle_, e7: init_, fU: update_};
	});
...
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.ce.e7(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.bv.e7(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.bz.e7(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.bT.e7(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.b3.e7(0);
		case 5:
			return $author$project$Spa$Generated$Pages$pages.ca.e7(0);
		default:
			var params = route.a;
			return $author$project$Spa$Generated$Pages$pages.bS.e7(params);
	}
};
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.ce.fU, msg, model);
					} else {
						break _v0$7;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bv.fU, msg, model);
					} else {
						break _v0$7;
					}
				case 2:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bz.fU, msg, model);
					} else {
						break _v0$7;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bT.fU, msg, model);
					} else {
						break _v0$7;
					}
				case 4:
					if (_v0.b.$ === 4) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.b3.fU, msg, model);
					} else {
						break _v0$7;
					}
				case 5:
					if (_v0.b.$ === 5) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.ca.fU, msg, model);
					} else {
						break _v0$7;
					}
				default:
					if (_v0.b.$ === 6) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bS.fU, msg, model);
					} else {
						break _v0$7;
					}
			}
		...
		switch (msg.$) {
			...
			case 1:
				...
				var shared = _Utils_update(
					original,
					{fV: url});
				var _v1 = _Utils_eq(url.d_, model.y.fV.d_) ? A2($author$project$Spa$Generated$Pages$load, model.D, shared) : A2(
					$author$project$Spa$Generated$Pages$init,
					$author$project$Utils$Route$fromUrl(url),
					shared);
				var page = _v1.a;
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('nav-link'),
																$elm$html$Html$Events$onClick(options.fs)
															]),
														_List_fromArray(
															[
...
var $author$project$Shared$view = F2(
	function (_v0, model) {
		...
		return {
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								$7: $author$project$Utils$Route$fromUrl(model.fV),
								fs: toMsg(0),
								P: model.P
							}),
							A2(
			...
			fM: $elm$core$String$isEmpty(page.fM) ? 'Conduit' : (page.fM + ' | Conduit')
		};
	});
...
var $author$project$Main$view = function (model) {
	return A2(
		$author$project$Shared$view,
		{
			...
			fQ: $author$project$Main$Shared
		},
		model.y);
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		e7: $author$project$Main$init,
		ft: $author$project$Main$UrlChanged,
		fu: $author$project$Main$LinkClicked,
		fI: $author$project$Main$subscriptions,
		fU: $author$project$Main$update,
		fW: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
