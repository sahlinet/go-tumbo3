...
var $author$project$Spa$Generated$Route$Profile__Username_String = function (a) {
	return {$: 'Profile__Username_String', a: a};
};
var $author$project$Spa$Generated$Route$Projects = {$: 'Projects'};
var $author$project$Spa$Generated$Route$Register = {$: 'Register'};
var $author$project$Spa$Generated$Route$Settings = {$: 'Settings'};
...
var $author$project$Shared$Model = F3(
	function (url, key, user) {
		return {key: key, url: url, user: user};
	});
var $author$project$Api$User$User = F3(
	function (email, token, username) {
		return {email: email, token: token, username: username};
	});
var $author$project$Api$Token$Token = function (a) {
	return {$: 'Token', a: a};
};
var $author$project$Api$Token$decoder = A2($elm$json$Json$Decode$map, $author$project$Api$Token$Token, $elm$json$Json$Decode$string);
...
var $author$project$Pages$Login$Model = F5(
	function (user, key, url, email, password) {
		return {email: email, key: key, password: password, url: url, user: user};
	});
var $author$project$Api$Data$NotAsked = {$: 'NotAsked'};
...
var $author$project$Pages$Login$save = F2(
	function (model, shared) {
		return _Utils_update(
			...
			{
				user: function () {
					var _v0 = $author$project$Api$Data$toMaybe(model.user);
					if (_v0.$ === 'Just') {
						var user = _v0.a;
...
var $author$project$Api$User$loginUrl = function (url) {
	return A2($elm$core$String$contains, 'localhost', url) ? 'http://localhost:8000/auth' : '/auth';
};
...
var $author$project$Api$User$authentication = function (options) {
	var body = $elm$http$Http$multipartBody(
		_List_fromArray(
			[
				A2($elm$http$Http$stringPart, 'username', options.user.email),
				A2($elm$http$Http$stringPart, 'password', options.user.password)
			]));
	return $elm$http$Http$post(
		{
			...
			expect: A2(
				...
				options.onResponse,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			url: $author$project$Api$User$loginUrl(options.browserLocation)
		});
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'token',
				$author$project$Api$Token$encode(user.token))
			]));
};
...
var $author$project$Ports$saveUser = function (user) {
	return $author$project$Ports$outgoing(
		{
			data: $author$project$Api$User$encode(user),
			tag: 'saveUser'
		});
};
					...
					$author$project$Api$User$authentication(
						{
							...
							onResponse: $author$project$Pages$Login$GotUser,
							...
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										A2($author$project$Utils$Route$navigate, model.key, $author$project$Spa$Generated$Route$Projects)
									]));
						} else {
...
var $author$project$Pages$Login$AttemptedSignIn = {$: 'AttemptedSignIn'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$type_(options.type_),
						$elm$html$Html$Attributes$value(options.value),
							...
							[
								...
								_List_fromArray(
									[
											...
											[
												...
												_List_fromArray(
													[
														...
														$author$project$Spa$Generated$Route$toString(options.alternateLink.route))
													]),
												_List_fromArray(
													[
														$elm$html$Html$text(options.alternateLink.label)
													]))
											])),
										function () {
										var _v0 = options.user;
										if (_v0.$ === 'Failure') {
											var reasons = _v0.a;
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onSubmit(options.onFormSubmit)
											]),
										$elm$core$List$concat(
											_List_fromArray(
												[
													A2($elm$core$List$map, $author$project$Components$UserForm$viewField, options.fields),
													_List_fromArray(
													[
														A2(
														$elm$html$Html$button,
	...
	return {
		body: _List_fromArray(
			[
				...
				{
					alternateLink: {label: 'Need an account?', route: $author$project$Spa$Generated$Route$Register},
					fields: _List_fromArray(
						[
							{
							label: 'Email',
							onInput: $author$project$Pages$Login$Updated($author$project$Pages$Login$Email),
							type_: 'text',
							value: model.email
						},
							{
							label: 'Password',
							onInput: $author$project$Pages$Login$Updated($author$project$Pages$Login$Password),
							type_: 'password',
							value: model.password
						}
						]),
					label: 'Sign in',
					onFormSubmit: $author$project$Pages$Login$AttemptedSignIn,
					user: model.user
				})
			]),
		title: 'Sign in'
...
var $author$project$Pages$Profile$Username_String$MyArticles = {$: 'MyArticles'};
...
var $author$project$Pages$Profile$Username_String$init = F2(
	function (shared, _v0) {
		...
		var token = A2(
			...
			shared.user);
		return _Utils_Tuple2(
			{listing: $author$project$Api$Data$Loading, page: 1, profile: $author$project$Api$Data$Loading, selectedTab: $author$project$Pages$Profile$Username_String$MyArticles, user: shared.user, username: params.username},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Api$Profile$get(
						{onResponse: $author$project$Pages$Profile$Username_String$GotProfile, token: token, username: params.username})
					])));
	});
...
var $author$project$Pages$Profile$Username_String$FavoritedArticles = {$: 'FavoritedArticles'};
	...
	function (profile, model) {
							...
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2(
										'active',
										_Utils_eq(tab, model.selectedTab))
									]))
							]),
						_List_fromArray(
							[
			...
			_List_fromArray(
				[
					...
					A2(
						...
						viewTab,
						_List_fromArray(
							[$author$project$Pages$Profile$Username_String$MyArticles, $author$project$Pages$Profile$Username_String$FavoritedArticles])))
				]));
		var isViewingOwnProfile = _Utils_eq(
			A2(
				...
				model.user),
			$elm$core$Maybe$Just(profile.username));
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Pages$Profile$Username_String$page = $author$project$Spa$Page$application(
	{init: $author$project$Pages$Profile$Username_String$init, load: $author$project$Pages$Profile$Username_String$load, save: $author$project$Pages$Profile$Username_String$save, subscriptions: $author$project$Pages$Profile$Username_String$subscriptions, update: $author$project$Pages$Profile$Username_String$update, view: $author$project$Pages$Profile$Username_String$view});
var $author$project$Pages$Projects$GotProjects = function (a) {
	return {$: 'GotProjects', a: a};
};
var $author$project$Api$Project$Project = F6(
	function (name, id, description, state, errormsg, gitrepository) {
		return {description: description, errormsg: errormsg, gitrepository: gitrepository, id: id, name: name, state: state};
	});
...
var $author$project$Api$Project$projectDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Api$Project$Project,
	...
	A2($elm$json$Json$Decode$field, 'gitrepository', $author$project$Api$Project$gitRepositoryDecoder));
var $author$project$Api$Project$list = function (options) {
	return A2(
		$author$project$Api$Token$get,
		options.token,
		{
			expect: A2(
				$author$project$Api$Data$expectJson,
				options.onResponse,
				$elm$json$Json$Decode$list($author$project$Api$Project$projectDecoder)),
			url: options.urlPrefix + '/api/v1/projects'
		});
};
var $author$project$Pages$Projects$makeUrl = function (host) {
	return A2($elm$core$String$contains, 'localhost', host) ? 'http://localhost:8000' : '';
};
var $author$project$Pages$Projects$fetchProjects = F2(
	function (model, host) {
		return $author$project$Api$Project$list(
			{
				onResponse: $author$project$Pages$Projects$GotProjects,
				token: A2(
					$elm$core$Maybe$map,
					function ($) {
						return $.token;
					...
					model.user),
				urlPrefix: $author$project$Pages$Projects$makeUrl(host)
			});
	});
var $author$project$Pages$Projects$init = F2(
	function (shared, _v0) {
		var model = {listing: $author$project$Api$Data$Loading, user: shared.user};
		return _Utils_Tuple2(
			model,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($author$project$Pages$Projects$fetchProjects, model, shared.url.host)
					])));
	});
var $author$project$Pages$Projects$load = F2(
	function (shared, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Projects$save = F2(
	function (model, shared) {
		return shared;
	});
var $author$project$Pages$Projects$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
...
var $author$project$Components$ProjectList$viewErrorDiv = function (listing) {
	return ($elm$core$String$length(listing.errormsg) > 0) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text(listing.errormsg)
			])) : $elm$html$Html$text('');
};
var $author$project$Components$ProjectList$viewProject = function (listing) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('highlight col-md-10')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(listing.name)
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(listing.description)
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
							...
							[
								...
								$elm$core$String$concat(
									_List_fromArray(
										[
											'/public/v1/projects/',
											$elm$core$String$fromInt(listing.id)
										])))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(listing.gitrepository.url)
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(listing.gitrepository.version)
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('badge badge-pill badge-secondary')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(listing.state)
					])),
				$author$project$Components$ProjectList$viewErrorDiv(listing)
			]));
};
var $author$project$Components$ProjectList$view = function (options) {
	var _v0 = options.projectListing;
	switch (_v0.$) {
		case 'NotAsked':
		...
		case 'Loading':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('project-preview')
					]),
				_List_fromArray(
					[
		...
		default:
			...
			return A2(
				...
				A2($elm$core$List$map, $author$project$Components$ProjectList$viewProject, listing));
	}
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Components$ProjectList$view(
								{projectListing: model.listing, user: model.user})
							]))
					]))
			]),
		title: 'Projects'
...
var $author$project$Pages$Projects$page = $author$project$Spa$Page$application(
	{init: $author$project$Pages$Projects$init, load: $author$project$Pages$Projects$load, save: $author$project$Pages$Projects$save, subscriptions: $author$project$Pages$Projects$subscriptions, update: $author$project$Pages$Projects$update, view: $author$project$Pages$Projects$view});
var $author$project$Pages$Register$Model = F5(
	function (user, key, username, email, password) {
		return {email: email, key: key, password: password, user: user, username: username};
	});
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'username',
							$elm$json$Json$Encode$string(options.user.username)),
							_Utils_Tuple2(
							'email',
							$elm$json$Json$Encode$string(options.user.email)),
							_Utils_Tuple2(
							'password',
							$elm$json$Json$Encode$string(options.user.password))
						])))
			]));
	return $elm$http$Http$post(
		{
...
var $author$project$Pages$Register$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AttemptedSignUp':
				return _Utils_Tuple2(
					model,
					$author$project$Api$User$registration(
						{
							onResponse: $author$project$Pages$Register$GotUser,
						...
						if (_v4.$ === 'Just') {
							...
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Ports$saveUser(user_),
										A2($author$project$Utils$Route$navigate, model.key, $author$project$Spa$Generated$Route$Top)
									]));
						} else {
							return $elm$core$Platform$Cmd$none;
						}
...
var $author$project$Pages$Register$AttemptedSignUp = {$: 'AttemptedSignUp'};
var $author$project$Pages$Register$Email = {$: 'Email'};
var $author$project$Pages$Register$Password = {$: 'Password'};
var $author$project$Pages$Register$Updated = F2(
	function (a, b) {
		return {$: 'Updated', a: a, b: b};
	});
var $author$project$Pages$Register$Username = {$: 'Username'};
	...
	return {
		body: _List_fromArray(
			[
				$author$project$Components$UserForm$view(
				{
					alternateLink: {label: 'Have an account?', route: $author$project$Spa$Generated$Route$Login},
					fields: _List_fromArray(
						[
							{
							label: 'Your Name',
							onInput: $author$project$Pages$Register$Updated($author$project$Pages$Register$Username),
							type_: 'text',
							value: model.username
						},
							{
							label: 'Email',
							onInput: $author$project$Pages$Register$Updated($author$project$Pages$Register$Email),
							type_: 'email',
							value: model.email
						},
							{
							label: 'Password',
							onInput: $author$project$Pages$Register$Updated($author$project$Pages$Register$Password),
							type_: 'password',
							value: model.password
						}
						]),
					label: 'Sign up',
					onFormSubmit: $author$project$Pages$Register$AttemptedSignUp,
					user: model.user
				})
			]),
		title: 'Sign up'
	...
	function (shared, _v0) {
		return _Utils_Tuple2(
			function () {
				...
				if (_v1.$ === 'Just') {
					var user = _v1.a;
					return {email: user.email, errors: _List_Nil, message: $elm$core$Maybe$Nothing, password: $elm$core$Maybe$Nothing, user: shared.user, username: user.username};
				} else {
					return {email: '', errors: _List_Nil, message: $elm$core$Maybe$Nothing, password: $elm$core$Maybe$Nothing, user: shared.user, username: ''};
				}
			}(),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Api$Token$put = F2(
	function (token, options) {
		return A4($author$project$Api$Token$request, 'PUT', options.body, token, options);
	});
var $author$project$Api$User$update = function (options) {
	...
	return A2(
		...
		$elm$core$Maybe$Just(options.token),
		{
			body: $elm$http$Http$jsonBody(body),
			expect: A2(
				$author$project$Api$Data$expectJson,
					...
					default:
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									password: $elm$core$Maybe$Just(value)
								}),
							$elm$core$Platform$Cmd$none);
				}
			case 'SubmittedForm':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{errors: _List_Nil, message: $elm$core$Maybe$Nothing}),
					$author$project$Api$User$update(
						{onResponse: $author$project$Pages$Settings$GotUser, token: user.token, user: model}));
			default:
				switch (msg.a.$) {
					case 'Success':
						var user = msg.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									message: $elm$core$Maybe$Just('User updated!'),
...
var $author$project$Pages$Settings$Email = {$: 'Email'};
var $author$project$Pages$Settings$Password = {$: 'Password'};
...
var $author$project$Pages$Settings$Username = {$: 'Username'};
										...
										[
											...
											_List_fromArray(
												[
													...
													$author$project$Components$ErrorList$view(model.errors),
													A2(
																		...
																		[
																			...
																			_List_fromArray(
																				[
																					...
																					$elm$html$Html$Events$onInput(
																					$author$project$Pages$Settings$Updated($author$project$Pages$Settings$Username))
																				]),
																			_List_Nil)
																		])),
																	A2(
																		...
																		[
																			...
																			_List_fromArray(
																				[
																					...
																					$elm$html$Html$Events$onInput(
																					$author$project$Pages$Settings$Updated($author$project$Pages$Settings$Email))
																				]),
																			_List_Nil)
																		])),
																	A2(
																		...
																		[
																			...
																			_List_fromArray(
																				[
																					...
																					$elm$html$Html$Events$onInput(
																					$author$project$Pages$Settings$Updated($author$project$Pages$Settings$Password))
																				]),
																			_List_Nil)
																		])),
																	A2(
...
var $author$project$Pages$Settings$page = $author$project$Spa$Page$application(
	{
		init: $author$project$Pages$Settings$init,
		load: $author$project$Pages$Settings$load,
		save: $author$project$Pages$Settings$save,
		subscriptions: $author$project$Pages$Settings$subscriptions,
		update: $author$project$Pages$Settings$update,
		view: $author$project$Utils$Auth$protected($author$project$Pages$Settings$view)
	});
var $author$project$Pages$Top$FeedFor = function (a) {
	return {$: 'FeedFor', a: a};
};
var $author$project$Pages$Top$Global = {$: 'Global'};
var $author$project$Pages$Top$init = F2(
	function (shared, _v0) {
		var activeTab = A2(
			$elm$core$Maybe$withDefault,
			$author$project$Pages$Top$Global,
			A2($elm$core$Maybe$map, $author$project$Pages$Top$FeedFor, shared.user));
		var model = {activeTab: activeTab, listing: $author$project$Api$Data$Loading, tags: $author$project$Api$Data$Loading, user: shared.user};
		return _Utils_Tuple2(
			model,
...
var $author$project$Spa$Generated$Pages$pages = {
	...
	profile__username_string: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Profile__Username_String__Model, $author$project$Spa$Generated$Pages$Profile__Username_String__Msg, $author$project$Pages$Profile$Username_String$page),
	projects: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Projects__Model, $author$project$Spa$Generated$Pages$Projects__Msg, $author$project$Pages$Projects$page),
	...
	settings: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Settings__Model, $author$project$Spa$Generated$Pages$Settings__Msg, $author$project$Pages$Settings$page),
...
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Projects':
			return $author$project$Spa$Generated$Pages$pages.projects.init(_Utils_Tuple0);
		case 'Register':
			return $author$project$Spa$Generated$Pages$pages.register.init(_Utils_Tuple0);
		case 'Settings':
			return $author$project$Spa$Generated$Pages$pages.settings.init(_Utils_Tuple0);
		default:
			var params = route.a;
			return $author$project$Spa$Generated$Pages$pages.profile__username_string.init(params);
	}
};
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		...
		case 'Projects__Model':
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.projects.bundle(model);
		case 'Register__Model':
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.register.bundle(model);
		case 'Settings__Model':
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.settings.bundle(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.profile__username_string.bundle(model);
	}
};
...
var $author$project$Ports$clearUser = $author$project$Ports$outgoing(
	{data: $elm$json$Json$Encode$null, tag: 'clearUser'});
	...
	function (bigMsg, bigModel) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'Projects__Msg':
					if (_v0.b.$ === 'Projects__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.projects.update, msg, model);
					} else {
						break _v0$7;
					}
				case 'Register__Msg':
				...
				case 'Settings__Msg':
					if (_v0.b.$ === 'Settings__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.settings.update, msg, model);
					} else {
						break _v0$7;
					}
				default:
					if (_v0.b.$ === 'Profile__Username_String__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.profile__username_string.update, msg, model);
					} else {
						break _v0$7;
					}
			}
		...
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var shared = _Utils_update(
					original,
					{url: url});
				var _v1 = _Utils_eq(url.path, model.shared.url.path) ? A2($author$project$Spa$Generated$Pages$load, model.page, shared) : A2(
					$author$project$Spa$Generated$Pages$init,
					$author$project$Utils$Route$fromUrl(url),
					shared);
				var page = _v1.a;
...
var $author$project$Shared$ClickedSignOut = {$: 'ClickedSignOut'};
								...
								return $elm$core$List$concat(
									_List_fromArray(
										[
											A2(
											$elm$core$List$map,
											$author$project$Components$Navbar$viewLink(options.currentRoute),
											_List_fromArray(
												[
													_Utils_Tuple2('Home', $author$project$Spa$Generated$Route$Top),
													_Utils_Tuple2('Projects', $author$project$Spa$Generated$Route$Projects),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('nav-link'),
																$elm$html$Html$Events$onClick(options.onSignOut)
															]),
														_List_fromArray(
															[
...
var $author$project$Shared$view = F2(
	function (_v0, model) {
		...
		return {
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								currentRoute: $author$project$Utils$Route$fromUrl(model.url),
								onSignOut: toMsg($author$project$Shared$ClickedSignOut),
								user: model.user
							}),
							A2(
							$elm$html$Html$div,
			...
			title: $elm$core$String$isEmpty(page.title) ? 'Tumbo' : (page.title + ' | Tumbo')
		};
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Api.Project.GitRepository":{"args":[],"type":"{ url : String.String, version : String.String }"},"Api.Profile.Profile":{"args":[],"type":"{ username : String.String, following : Basics.Bool }"},"Api.Project.Project":{"args":[],"type":"{ name : String.String, id : Basics.Int, description : String.String, state : String.String, errormsg : String.String, gitrepository : Api.Project.GitRepository }"},"Api.Article.Tag.Tag":{"args":[],"type":"String.String"},"Api.User.User":{"args":[],"type":"{ email : String.String, token : Api.Token.Token, username : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"ClickedSignOut":[]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"Top__Msg":["Pages.Top.Msg"],"Login__Msg":["Pages.Login.Msg"],"NotFound__Msg":["Pages.NotFound.Msg"],"Projects__Msg":["Pages.Projects.Msg"],"Register__Msg":["Pages.Register.Msg"],"Settings__Msg":["Pages.Settings.Msg"],"Profile__Username_String__Msg":["Pages.Profile.Username_String.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.Login.Msg":{"args":[],"tags":{"Updated":["Pages.Login.Field","String.String"],"AttemptedSignIn":[],"GotUser":["Api.Data.Data Api.User.User"]}},"Pages.Profile.Username_String.Msg":{"args":[],"tags":{"GotProfile":["Api.Data.Data Api.Profile.Profile"],"GotArticles":["Api.Data.Data (List.List Api.Project.Project)"],"Clicked":["Pages.Profile.Username_String.Tab"],"ClickedPage":["Basics.Int"]}},"Pages.Projects.Msg":{"args":[],"tags":{"GotProjects":["Api.Data.Data (List.List Api.Project.Project)"],"StartProject":["Api.Project.Project"]}},"Pages.Register.Msg":{"args":[],"tags":{"Updated":["Pages.Register.Field","String.String"],"AttemptedSignUp":[],"GotUser":["Api.Data.Data Api.User.User"]}},"Pages.Settings.Msg":{"args":[],"tags":{"Updated":["Pages.Settings.Field","String.String"],"SubmittedForm":["Api.User.User"],"GotUser":["Api.Data.Data Api.User.User"]}},"Pages.Top.Msg":{"args":[],"tags":{"GotArticles":["Api.Data.Data (List.List Api.Project.Project)"],"GotTags":["Api.Data.Data (List.List Api.Article.Tag.Tag)"],"SelectedTab":["Pages.Top.Tab"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Api.Data.Data":{"args":["value"],"tags":{"NotAsked":[],"Loading":[],"Failure":["List.List String.String"],"Success":["value"]}},"Pages.Login.Field":{"args":[],"tags":{"Email":[],"Password":[]}},"Pages.Register.Field":{"args":[],"tags":{"Username":[],"Email":[],"Password":[]}},"Pages.Settings.Field":{"args":[],"tags":{"Username":[],"Email":[],"Password":[]}},"List.List":{"args":["a"],"tags":{}},"Pages.Profile.Username_String.Tab":{"args":[],"tags":{"MyArticles":[],"FavoritedArticles":[]}},"Pages.Top.Tab":{"args":[],"tags":{"FeedFor":["Api.User.User"],"Global":[],"TagFilter":["Api.Article.Tag.Tag"]}},"Api.Token.Token":{"args":[],"tags":{"Token":["String.String"]}}}}})}});}(this));