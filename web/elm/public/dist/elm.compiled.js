...
{
	if (region.c2.aC === region.ds.aC)
	{
		return 'on line ' + region.c2.aC;
	}
	return 'on lines ' + region.c2.aC + ' through ' + region.ds.aC;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { e5: 'hidden', eM: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { e5: 'mozHidden', eM: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { e5: 'msHidden', eM: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { e5: 'webkitHidden', eM: 'webkitvisibilitychange' }
		: { e5: 'hidden', eM: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.fh, request.f_, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dw: fragment, e6: host, dX: path, dZ: port_, d2: protocol, cS: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {S: frag, fB: params, N: unvisited, ez: value, W: visited};
	});
...
var $author$project$Pages$Login$Model = F5(
	function (user, key, url, email, password) {
		return {av: email, fd: key, cN: password, f_: url, O: user};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{eH: false, eJ: r.eJ, eX: r.eX, e3: r.e3, fh: r.fh, fQ: r.fQ, fY: r.fY, f_: r.f_}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{eJ: r.eJ, eX: r.eX, e3: _List_Nil, fh: 'POST', fQ: $elm$core$Maybe$Nothing, fY: $elm$core$Maybe$Nothing, f_: r.f_});
};
	...
	var body = $elm$http$Http$multipartBody(
		_List_fromArray(
			[
				...
				A2($elm$http$Http$stringPart, 'password', options.O.cN)
			]));
	return $elm$http$Http$post(
		{
			...
			eX: A2(
				...
				options.fv,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			f_: $author$project$Api$User$loginUrl(options.eL)
		});
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'username',
				$elm$json$Json$Encode$string(user.cf)),
				_Utils_Tuple2(
				'email',
				$elm$json$Json$Encode$string(user.av)),
				_Utils_Tuple2(
				'token',
				$author$project$Api$Token$encode(user.c9))
			]));
};
...
var $author$project$Ports$saveUser = function (user) {
	return $author$project$Ports$outgoing(
		{
			cs: $author$project$Api$User$encode(user),
			c7: 'saveUser'
		});
};
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$User$authentication(
						{
							eL: model.f_.e6,
							fv: $author$project$Pages$Login$GotUser,
							O: {av: model.av, cN: model.cN}
						}));
			default:
				var user = msg.a;
				return _Utils_Tuple2(
							...
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										A2($author$project$Utils$Route$navigate, model.fd, $author$project$Spa$Generated$Route$Projects)
									]));
						} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder(options.fe),
						$elm$html$Html$Attributes$type_(options.ex),
						$elm$html$Html$Attributes$value(options.ez),
						$elm$html$Html$Events$onInput(options.dU)
					]),
				_List_Nil)
			]));
};
							...
							[
								...
								_List_fromArray(
									[
											...
											[
												...
												_List_fromArray(
													[
														...
														$author$project$Spa$Generated$Route$toString(options.de.fI))
													]),
												_List_fromArray(
													[
														$elm$html$Html$text(options.de.fe)
													]))
											])),
										function () {
										var _v0 = options.O;
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onSubmit(options.ft)
											]),
										$elm$core$List$concat(
											_List_fromArray(
												[
													A2($elm$core$List$map, $author$project$Components$UserForm$viewField, options.e0),
													_List_fromArray(
													[
														A2(
	...
	return {
		eJ: _List_fromArray(
			[
				...
				{
					de: {fe: 'Need an account?', fI: $author$project$Spa$Generated$Route$Register},
					e0: _List_fromArray(
						[
							{
							fe: 'Email',
							dU: $author$project$Pages$Login$Updated(0),
							ex: 'text',
							ez: model.av
						},
							{
							fe: 'Password',
							dU: $author$project$Pages$Login$Updated(1),
							ex: 'password',
							ez: model.cN
						}
						]),
					fe: 'Sign in',
					ft: $author$project$Pages$Login$AttemptedSignIn,
					O: model.O
				})
			]),
		fR: 'Sign in'
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{fb: $author$project$Pages$Login$init, fg: $author$project$Pages$Login$load, fJ: $author$project$Pages$Login$save, fN: $author$project$Pages$Login$subscriptions, fZ: $author$project$Pages$Login$update, f0: $author$project$Pages$Login$view});
...
var $author$project$Api$Profile$Profile = F2(
	function (username, following) {
		return {e1: following, cf: username};
	});
		...
		return $elm$http$Http$request(
			{
				...
				fh: method,
				fQ: $elm$core$Maybe$Just(1000 * 60),
...
var $author$project$Api$Profile$get = function (options) {
	return A2(
		...
		options.c9,
		{
			...
			f_: 'https://conduit.productionready.io/api/profiles/' + options.cf
		});
};
...
var $author$project$Pages$Profile$Username_String$init = F2(
	function (shared, _v0) {
		...
		var token = A2(
			...
			shared.O);
		return _Utils_Tuple2(
			{dM: $author$project$Api$Data$Loading, C: 1, cR: $author$project$Api$Data$Loading, cW: 0, O: shared.O, cf: params.cf},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Api$Profile$get(
						{fv: $author$project$Pages$Profile$Username_String$GotProfile, c9: token, cf: params.cf})
					])));
	});
	...
	function (profile, model) {
		...
		var isViewingOwnProfile = _Utils_eq(
			A2(
				...
				model.O),
			$elm$core$Maybe$Just(profile.cf));
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Pages$Profile$Username_String$page = $author$project$Spa$Page$application(
	{fb: $author$project$Pages$Profile$Username_String$init, fg: $author$project$Pages$Profile$Username_String$load, fJ: $author$project$Pages$Profile$Username_String$save, fN: $author$project$Pages$Profile$Username_String$subscriptions, fZ: $author$project$Pages$Profile$Username_String$update, f0: $author$project$Pages$Profile$Username_String$view});
var $author$project$Pages$Projects$GotProjects = function (a) {
	return {$: 0, a: a};
};
var $author$project$Api$Project$Project = F5(
	function (name, id, description, state, gitrepository) {
		return {eS: description, e2: gitrepository, e9: id, fj: name, ej: state};
	});
...
var $author$project$Api$Project$ProjectState = F2(
	function (state, errormsg) {
		return {eV: errormsg, ej: state};
	});
var $author$project$Api$Project$projectStateDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Api$Project$ProjectState,
...
var $author$project$Api$Project$projectDecoder = A6(
	...
	A2($elm$json$Json$Decode$field, 'state', $author$project$Api$Project$projectStateDecoder),
...
var $author$project$Pages$Projects$fetchProjects = F2(
	function (model, host) {
		return $author$project$Api$Project$list(
			{
				fv: $author$project$Pages$Projects$GotProjects,
				c9: A2(
					$elm$core$Maybe$map,
					function ($) {
						return $.c9;
...
var $author$project$Pages$Projects$init = F2(
	function (shared, _v0) {
		var model = {dM: $author$project$Api$Data$Loading, O: shared.O};
		return _Utils_Tuple2(
			model,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($author$project$Pages$Projects$fetchProjects, model, shared.f_.e6)
					])));
	});
...
var $author$project$Components$ProjectList$viewErrorDiv = function (listing) {
	return ($elm$core$String$length(listing.ej.eV) > 0) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text(listing.ej.eV)
			])) : $elm$html$Html$text('');
};
	...
	return A2(
		...
		_List_fromArray(
			[
							...
							[
								...
								$elm$core$String$concat(
									_List_fromArray(
										[
											'/public/v1/projects/',
											$elm$core$String$fromInt(listing.e9)
										])))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(listing.ej.ej)
					])),
...
var $author$project$Pages$Projects$page = $author$project$Spa$Page$application(
	{fb: $author$project$Pages$Projects$init, fg: $author$project$Pages$Projects$load, fJ: $author$project$Pages$Projects$save, fN: $author$project$Pages$Projects$subscriptions, fZ: $author$project$Pages$Projects$update, f0: $author$project$Pages$Projects$view});
var $author$project$Pages$Register$Model = F5(
	function (user, key, username, email, password) {
		return {av: email, fd: key, cN: password, O: user, cf: username};
	});
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'username',
							$elm$json$Json$Encode$string(options.O.cf)),
							_Utils_Tuple2(
							'email',
							$elm$json$Json$Encode$string(options.O.av)),
							_Utils_Tuple2(
							'password',
							$elm$json$Json$Encode$string(options.O.cN))
						])))
			]));
	return $elm$http$Http$post(
		{
			...
			eX: A2(
				...
				options.fv,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			f_: 'https://conduit.productionready.io/api/users'
		});
};
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$User$registration(
						{
							fv: $author$project$Pages$Register$GotUser,
							O: {av: model.av, cN: model.cN, cf: model.cf}
						}));
			default:
				var user = msg.a;
				return _Utils_Tuple2(
						...
						if (!_v4.$) {
							...
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Ports$saveUser(user_),
										A2($author$project$Utils$Route$navigate, model.fd, $author$project$Spa$Generated$Route$Top)
									]));
						} else {
							return $elm$core$Platform$Cmd$none;
						}
	...
	return {
		eJ: _List_fromArray(
			[
				$author$project$Components$UserForm$view(
				{
					de: {fe: 'Have an account?', fI: $author$project$Spa$Generated$Route$Login},
					e0: _List_fromArray(
						[
							{
							fe: 'Your Name',
							dU: $author$project$Pages$Register$Updated(0),
							ex: 'text',
							ez: model.cf
						},
							{
							fe: 'Email',
							dU: $author$project$Pages$Register$Updated(1),
							ex: 'email',
							ez: model.av
						},
							{
							fe: 'Password',
							dU: $author$project$Pages$Register$Updated(2),
							ex: 'password',
							ez: model.cN
						}
						]),
					fe: 'Sign up',
					ft: $author$project$Pages$Register$AttemptedSignUp,
					O: model.O
				})
			]),
		fR: 'Sign up'
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{fb: $author$project$Pages$Register$init, fg: $author$project$Pages$Register$load, fJ: $author$project$Pages$Register$save, fN: $author$project$Pages$Register$subscriptions, fZ: $author$project$Pages$Register$update, f0: $author$project$Pages$Register$view});
	...
	function (shared, _v0) {
		return _Utils_Tuple2(
			function () {
				...
				if (!_v1.$) {
					var user = _v1.a;
					return {av: user.av, ab: _List_Nil, ah: $elm$core$Maybe$Nothing, cN: $elm$core$Maybe$Nothing, O: shared.O, cf: user.cf};
				} else {
					return {av: '', ab: _List_Nil, ah: $elm$core$Maybe$Nothing, cN: $elm$core$Maybe$Nothing, O: shared.O, cf: ''};
				}
			}(),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Api$User$update = function (options) {
	...
	return A2(
		...
		$elm$core$Maybe$Just(options.c9),
		{
			eJ: $elm$http$Http$jsonBody(body),
			eX: A2(
				$author$project$Api$Data$expectJson,
				options.fv,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			f_: 'https://conduit.productionready.io/api/user'
		});
};
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					$author$project$Api$User$update(
						{fv: $author$project$Pages$Settings$GotUser, c9: user.c9, O: model}));
			default:
				switch (msg.a.$) {
					case 3:
						var user = msg.a.a;
																		...
																		[
																			...
																			_List_fromArray(
																				[
																					...
																					A2($elm$core$Maybe$withDefault, '', model.cN)),
																					$elm$html$Html$Events$onInput(
...
var $author$project$Pages$Settings$page = $author$project$Spa$Page$application(
	{
		fb: $author$project$Pages$Settings$init,
		fg: $author$project$Pages$Settings$load,
		fJ: $author$project$Pages$Settings$save,
...
var $author$project$Pages$Top$init = F2(
	function (shared, _v0) {
		...
		var model = {db: activeTab, dM: $author$project$Api$Data$Loading, eo: $author$project$Api$Data$Loading, O: shared.O};
		return _Utils_Tuple2(
			model,
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{fb: $author$project$Pages$Top$init, fg: $author$project$Pages$Top$load, fJ: $author$project$Pages$Top$save, fN: $author$project$Pages$Top$subscriptions, fZ: $author$project$Pages$Top$update, f0: $author$project$Pages$Top$view});
	...
	function (params, key, url) {
		return {
			...
			cS: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.cS)),
			d3: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.fb,
						shared,
						A3($author$project$Spa$Url$create, params, shared.fd, shared.f_)));
			});
		...
		return {D: bundle_, fb: init_, fZ: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	bt: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Login__Model, $author$project$Spa$Generated$Pages$Login__Msg, $author$project$Pages$Login$page),
	bx: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$NotFound__Model, $author$project$Spa$Generated$Pages$NotFound__Msg, $author$project$Pages$NotFound$page),
	bQ: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Profile__Username_String__Model, $author$project$Spa$Generated$Pages$Profile__Username_String__Msg, $author$project$Pages$Profile$Username_String$page),
	bR: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Projects__Model, $author$project$Spa$Generated$Pages$Projects__Msg, $author$project$Pages$Projects$page),
	b1: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Register__Model, $author$project$Spa$Generated$Pages$Register__Msg, $author$project$Pages$Register$page),
	b8: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Settings__Model, $author$project$Spa$Generated$Pages$Settings__Msg, $author$project$Pages$Settings$page),
	cc: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Top__Model, $author$project$Spa$Generated$Pages$Top__Msg, $author$project$Pages$Top$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.cc.fb(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.bt.fb(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.bx.fb(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.bR.fb(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.b1.fb(0);
		case 5:
			return $author$project$Spa$Generated$Pages$pages.b8.fb(0);
		default:
			var params = route.a;
			return $author$project$Spa$Generated$Pages$pages.bQ.fb(params);
	}
};
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.cc.D(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.bt.D(model);
		case 2:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.bx.D(model);
		case 3:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.bR.D(model);
		case 4:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.b1.D(model);
		case 5:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.b8.D(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.bQ.D(model);
	}
};
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cc.fZ, msg, model);
					} else {
						break _v0$7;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bt.fZ, msg, model);
					} else {
						break _v0$7;
					}
				case 2:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bx.fZ, msg, model);
					} else {
						break _v0$7;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bR.fZ, msg, model);
					} else {
						break _v0$7;
					}
				case 4:
					if (_v0.b.$ === 4) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.b1.fZ, msg, model);
					} else {
						break _v0$7;
					}
				case 5:
					if (_v0.b.$ === 5) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.b8.fZ, msg, model);
					} else {
						break _v0$7;
					}
				default:
					if (_v0.b.$ === 6) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.bQ.fZ, msg, model);
					} else {
						break _v0$7;
					}
			}
		...
		switch (msg.$) {
			...
			case 1:
				...
				var shared = _Utils_update(
					original,
					{f_: url});
				var _v1 = _Utils_eq(url.dX, model.x.f_.dX) ? A2($author$project$Spa$Generated$Pages$load, model.C, shared) : A2(
					$author$project$Spa$Generated$Pages$init,
					$author$project$Utils$Route$fromUrl(url),
					shared);
				var page = _v1.a;
								...
								return $elm$core$List$concat(
									_List_fromArray(
										[
											A2(
											$elm$core$List$map,
											$author$project$Components$Navbar$viewLink(options.dm),
											_List_fromArray(
												[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('nav-link'),
																$elm$html$Html$Events$onClick(options.fw)
															]),
														_List_fromArray(
															[
...
var $author$project$Shared$view = F2(
	function (_v0, model) {
		...
		return {
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								dm: $author$project$Utils$Route$fromUrl(model.f_),
								fw: toMsg(0),
								O: model.O
							}),
							A2(
			...
			fR: $elm$core$String$isEmpty(page.fR) ? 'Tumbo' : (page.fR + ' | Tumbo')
		};
	});
...
var $author$project$Main$view = function (model) {
	return A2(
		$author$project$Shared$view,
		{
			...
			fV: $author$project$Main$Shared
		},
		model.x);
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		fb: $author$project$Main$init,
		fx: $author$project$Main$UrlChanged,
		fy: $author$project$Main$LinkClicked,
