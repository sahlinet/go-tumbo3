	...
	return $elm$http$Http$post(
		{
			...
			eW: A2(
				...
				options.fs,
				A2($elm$json$Json$Decode$field, 'user', $author$project$Api$User$decoder)),
			fW: $author$project$Api$User$loginUrl('localhost')
		});
};
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{e8: $author$project$Pages$Login$init, fd: $author$project$Pages$Login$load, fF: $author$project$Pages$Login$save, fJ: $author$project$Pages$Login$subscriptions, fV: $author$project$Pages$Login$update, fX: $author$project$Pages$Login$view});
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{fX: $author$project$Pages$NotFound$view});
...
var $author$project$Api$Project$list = function (options) {
	return A2(
		...
		options.db,
		{
			...
			fW: 'http://localhost:8000/api/v1/projects'
		});
};
...
var $author$project$Pages$Projects$page = $author$project$Spa$Page$application(
	{e8: $author$project$Pages$Projects$init, fd: $author$project$Pages$Projects$load, fF: $author$project$Pages$Projects$save, fJ: $author$project$Pages$Projects$subscriptions, fV: $author$project$Pages$Projects$update, fX: $author$project$Pages$Projects$view});
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{e8: $author$project$Pages$Register$init, fd: $author$project$Pages$Register$load, fF: $author$project$Pages$Register$save, fJ: $author$project$Pages$Register$subscriptions, fV: $author$project$Pages$Register$update, fX: $author$project$Pages$Register$view});
...
var $author$project$Pages$Settings$page = $author$project$Spa$Page$application(
	{
		...
		fX: $author$project$Utils$Auth$protected($author$project$Pages$Settings$view)
	});
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{e8: $author$project$Pages$Top$init, fd: $author$project$Pages$Top$load, fF: $author$project$Pages$Top$save, fJ: $author$project$Pages$Top$subscriptions, fV: $author$project$Pages$Top$update, fX: $author$project$Pages$Top$view});
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		fX: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
