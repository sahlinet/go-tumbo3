...
var $author$project$Shared$Model = F4(
	function (url, key, email, token) {
		return {email: email, key: key, token: token, url: url};
	});
var $author$project$Shared$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A4($author$project$Shared$Model, url, key, '', ''),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Pages$Login$getTokenCompleted = F2(
		...
		if (result.$ === 'Ok') {
			...
			return _Utils_Tuple2(
				A2(
					...
					_Utils_update(
						model,
						{password: '', token: newToken})),
				$elm$core$Platform$Cmd$none);
		} else {
			var error = result.a;
			return _Utils_Tuple2(
				A2($elm$core$Debug$log, 'error', model),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Pages$Login$GetTokenCompleted = function (a) {
...
var $author$project$Pages$Login$loginUrl = 'http://localhost:8000/auth';
...
var $author$project$Pages$Login$responseDecoder = A2($elm$json$Json$Decode$field, 'token', $elm$json$Json$Decode$string);
var $elm$http$Http$stringPart = _Http_pair;
var $author$project$Pages$Login$loginRequestCmd = F2(
	function (model, apiUrl) {
		var body = $elm$http$Http$multipartBody(
			_List_fromArray(
				[
					A2($elm$http$Http$stringPart, 'username', 'user1'),
					A2($elm$http$Http$stringPart, 'password', 'password')
				]));
		return $elm$http$Http$post(
			{
				body: body,
				expect: A2($elm$http$Http$expectJson, $author$project$Pages$Login$GetTokenCompleted, $author$project$Pages$Login$responseDecoder),
				url: $author$project$Pages$Login$loginUrl
			});
	});
var $author$project$Pages$Login$update = F2(
	function (msg, model) {
		if (msg.$ === 'SignIn') {
			return _Utils_Tuple2(
				model,
				A2($author$project$Pages$Login$loginRequestCmd, model, $author$project$Pages$Login$loginUrl));
		} else {
			var result = msg.a;
			return A2($author$project$Pages$Login$getTokenCompleted, model, result);
		}
	});
var $author$project$Pages$Login$SignIn = {$: 'SignIn'};
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$for('exampleInputEmail1')
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																A2($elm$html$Html$Attributes$attribute, 'aria-describedby', 'emailHelp'),
																$elm$html$Html$Attributes$class('form-control'),
																$elm$html$Html$Attributes$id('exampleInputEmail1'),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$for('exampleInputPassword1')
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('form-control'),
																$elm$html$Html$Attributes$id('exampleInputPassword1'),
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Events$onClick($author$project$Pages$Login$SignIn)
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Sign in')
...
var $author$project$Pages$Register$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
...
var $author$project$Pages$Register$view = function (model) {
	return {body: _List_Nil, title: 'Register'};
};
...
var $author$project$Components$Navbar$view = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('navbar-right navbar-link'),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Pages.Top.Msg":{"args":[],"type":"Basics.Never"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"SignIn":["String.String"]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"Top__Msg":["Pages.Top.Msg"],"ExamplePage__Msg":["Pages.ExamplePage.Msg"],"Login__Msg":["Pages.Login.Msg"],"NotFound__Msg":["Pages.NotFound.Msg"],"Register__Msg":["Pages.Register.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.ExamplePage.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}},"Pages.Login.Msg":{"args":[],"tags":{"SignIn":[],"GetTokenCompleted":["Result.Result Http.Error String.String"]}},"Pages.Register.Msg":{"args":[],"tags":{"ReplaceMe":[]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));